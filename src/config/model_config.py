...
WORKFLOWS = {
    "tree": WorkflowConfig(
        ...
        regression_candidates=["lightgbm", "xgboost", "hist_gradient_boosting"],
        classification_candidates=["lightgbm", "xgboost", "hist_gradient_boosting"],
    ...
    "non_tree": WorkflowConfig(
        ...
        regression_candidates=["ridge", "elasticnet", "svr_rbf", "knn_regressor"],
        classification_candidates=["logistic_regression", "svc_rbf", "knn_classifier"],
